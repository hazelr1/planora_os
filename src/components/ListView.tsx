              ...
              {sorted.length === 0 ? (
                ...
                sorted.map((a, idx) => (
                  <div
                    ...
                    className={`px-5 py-3 flex items-center gap-3 hover:bg-white/5 transition cursor-pointer animate-fade-in ${
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <button
                        ...
                        className="rounded-lg p-1.5 text-ink-500 hover:text-rose-400 hover:bg-rose-500/10 transition"
                        aria-label="Delete"
                      >
                        <Trash2 size={13} />
                      </button>
