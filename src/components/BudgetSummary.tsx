    ...
    <div className={`card p-5 ${over ? 'border-rose-500/20' : ''}`}>
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex items-center justify-between text-sm pt-1 border-t border-glass/10">
          ...
          <span className={`font-700 ${over ? 'text-rose-700 dark:text-rose-400' : 'text-brand-700 dark:text-brand-300'}`}>
      ...
      <div className="mt-4">
        ...
        <div className="flex items-center justify-between mt-2 text-xs">
          ...
          <span className={`flex items-center gap-1 font-medium ${over ? 'text-rose-700 dark:text-rose-400' : 'text-brand-700 dark:text-brand-300'}`}>
