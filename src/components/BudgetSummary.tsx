...
export default function BudgetSummary({ trip }: BudgetSummaryProps) {
  ...
  return (
    <div className={`card p-5 ${over ? 'border-rose-500/20' : ''}`}>
      ...
      {over && (
        <div className="mb-4 rounded-xl bg-rose-500/10 border border-rose-500/20 px-3 py-2.5 flex items-start gap-2">
      ...
      <div className="mt-4">
        ...
        <div className="flex items-center justify-between mt-2 text-xs">
          ...
          <span className={`flex items-center gap-1 font-medium ${over ? 'text-rose-400' : 'text-brand-300'}`}>
